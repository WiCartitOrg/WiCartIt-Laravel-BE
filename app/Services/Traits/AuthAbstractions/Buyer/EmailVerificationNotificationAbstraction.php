...
trait EmailVerificationNotificationAbstraction
{
    ...
    protected function SendVerificationReqMail(Request $request, string $url_title, array $other_url_params)/*:
        bool*/
    {
        //redirect if buyer is verified:
        $email_was_verified = $this->BuyerDetailsFoundService($request)->is_email_verified;
        ...
        //event(new BuyerHasRegistered($request, $verify_link));
