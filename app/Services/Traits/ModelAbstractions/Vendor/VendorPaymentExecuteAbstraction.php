...
use App\Services\Traits\ModelCRUD\PaymentTransactionCRUD;

use App\Services\Hooks\StripePaymentHook;

trait VendorPaymentExecuteAbstraction
{
	//inherits all their methods:
	use CartCRUD;
	use BuyerCRUD;
	use PaymentTransactionCRUD;
	use StripePaymentHook;//note  stripe API is not used here...

	protected function VendorMakePaymentService(Request $request): array 
	{
		//init:
