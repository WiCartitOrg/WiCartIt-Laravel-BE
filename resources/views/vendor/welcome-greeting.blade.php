...
<html>
    ...
    <body class="w3-myfont w3-custom-purple w3-text-white">
        ...
        <br/><br/>
        <p>
            <strong> Hello from this side <b>{{$vendor_request->vendor_first_name}} {{$vendor_request->vendor_last_name}}</b>,</strong>
        </p>
        ...
        <p>
            <b> 
                <strong>
                    Welcome to Wicart! Your selling experience is about to be re-defined!  <br/>
